...
def num_rushes(slope_height, rush_height_gain, back_sliding, start_height=0):
    ...
    """
    # ---start student section---
    # Base case: already at or above slope
    ...
    # If reached or passed the slope height, no back slide and stop
    if new_height >= slope_height:
        return 1

    # Otherwise, slide back
    new_height -= back_sliding

    # Recursive call for next rush
    return 1 + num_rushes(slope_height, rush_height_gain, back_sliding, new_height)
    # ===end student section===
